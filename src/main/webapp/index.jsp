<%-- 
    Document   : index
    Created on : 11-11-2022, 16:25:56
    Author     : jr972
--%>
        ...
        <div class="d-flex flex-column flex-shrink-0 sidebar close">
            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="SuperAdmin/Productos.jsp">Hogar</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="SuperAdmin/Ofertas.jsp">Perfumes</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                    ...
                    <ul class="sub-menu">
                        <li><a class="link_name" href="SuperAdmin/Pedidos.jsp">Sorpresas</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                    ...
                    <ul class="sub-menu">
                        <li><a class="link_name" href="SuperAdmin/Agenda.jsp">Vestuario</a></li>
                    </ul>
                </li>
                <li>
                    <div class="profile-details">
                        <div class="profile-content">
                            <a class="nav-link active text-white" aria-current="page" href="Login.jsp">
                                <i class='bx bx-user' ></i>
                            </a>
                        </div>
                        <div class="name-job">
                            <div class="profile_name">Iniciar Sesion</div>
                            <div class="job"></div>
                        </div>
                        <a href="Login.jsp"><i class='bx bx-user perfil'></i></a>
                    </div>
                </li>
            </ul>
        </div>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-lg-none d-block nav-links">
                            ...
                            <li>
                                <div class="profile-details" >
                                    ...
                                    <div class="name-job">
                                        <div class="profile_name">Ingresar</div>
                                        <div class="job"></div>
                                    </div>
                                    <a href="Login.jsp"><i class='bx bx-user perfil'></i></a>
                                </div>
                ...
                <div class="d-lg-block d-md-block d-none profile-nav" style="margin-right: 50px;">
                    ...
                    <span class="text-white mb-2" style="font-size: 24px;">Ingresar</span>
                </div>
