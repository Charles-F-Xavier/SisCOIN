...
<%@page import="service.Dao_Detalle"%>
<%@page import="java.util.List"%>
<%@page import="model.Pedido"%>
<%@page import="db.DAO"%>
<%@page import="model.Venta"%>
<%@page import="service.Dao_Venta"%>
...
<html>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="viewOrderLabel">Modal title</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <input type="hidden" name="txt_Pedido" id="idOrderDetail">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <table id="detail" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            Dao_Detalle oDao_Detalle = new Dao_Detalle(oConexionSingleton);
                                                            Dao_Producto oDao_Producto = new Dao_Producto(oConexionSingleton);

                                                            List<Detalle> oListDetalle = oDao_Detalle.getAllByVenta(1);
                                                            for (Detalle oDetalle : oListDetalle) {
                                                                Producto oProducto = oDao_Producto.get(oDetalle.getId_producto());
                                                        %>
                                                        <tr>
                                                            <td><% out.print(oDetalle.getId()); %></td>
                                                            <td><% out.print(oProducto.getNombre()); %></td>
                                                            <td><% out.print(oDetalle.getCantidad()); %></td>
                                                        </tr>
                                                        <%
                                                            }
                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <%                                            DAO oDao = new DAO(oConexionSingleton);
                                            List<Pedido> oListPedido = oDao.getPedidos();
                                            for (Pedido oPedido : oListPedido) {
                                        %>
                                        <tr>
                                            <td><% out.print(oPedido.getId());%></td>
                                            <td><% out.print(oPedido.getCliente());%></td>
                                            <td><% out.print(oPedido.getFecha());%></td>
                                            <td><% out.print(oPedido.getHora());%></td>
                                            <td><% out.print(oPedido.getTipo_pedido());%></td>
                                            <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewOrder" data-bs-whatever="<%=oPedido.getId()%>"><i class="bi bi-ticket-detailed"></i></button></td>
                                            <td><button type="button" class="btn btn-primary"><i class="bi bi-bag-check"></i></button></td>
                                            <td><button type="button" class="btn btn-primary"><i class="bi bi-trash"></i></button></td>
                                        </tr>
                                        <%
                                            }
                                        %>
    ...
    <script>
        ...
        const exampleModal = document.getElementById('viewOrder');
        exampleModal.addEventListener('show.bs.modal', event => {
            ...
            const modalTitle = document.getElementById('viewOrderLabel');
            const modalInput = document.getElementById('idOrderDetail');
            console.log(modalTitle);
            //const modalBodyInput = exampleModal.querySelector('.modal-body input');

            modalTitle.textContent = `Detalle del pedido N°` + recipient;
