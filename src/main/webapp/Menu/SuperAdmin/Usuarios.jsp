        ...
        <section class="home-section principal">
            <div class="container-fluid principal mt-2">
                <div class="row justify-content-end">
                    ...
                    <div class="col-sm-10 col-md-1 col-lg-1 col-xl-1 align-self-end m-2 d-grid gap-1 d-sm-flex d-md-flex d-lg-flex justify-content-sm-end justify-content-md-center justify-content-lg-center">
