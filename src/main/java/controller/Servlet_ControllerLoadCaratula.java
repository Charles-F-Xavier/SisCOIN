 ...
 * @author jr972
 */
@WebServlet(name = "Servlet_ControllerLoadCaratula", urlPatterns = {"/LoadCaratula"})
public class Servlet_ControllerLoadCaratula extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            oDao_Producto.loadCaratula(id, response);
        } catch (Exception e) {
        }
    }
